...
class QuizInterface:
    def __init__(self, quiz_brain):
        ...
        true_path = os.path.join("images", "true.png")
        false_path = os.path.join("images", "false.png")
        
        self.true_image = PhotoImage(file=true_path)
        self.false_image = PhotoImage(file=false_path)
